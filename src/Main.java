...
public class Main {
    public static void main(String[] args) {
        ...
        Film film1 = new Film("Inception", 1, "Sci-Fi", 2011, 8.8, 2797, 12.99);
        ...
        System.out.println("\n----- Updated Film Example -----");
        film1.displayFilmDetails();
        film1.updateFilmDetails("Inception", "Sci-Fi", 2010, 8.8, 2797, 12.99);
        System.out.println("Updated film1:"+""+film1);
        System.out.println("----------------------------------------");
        ...
        // Deleting a film
        System.out.println("\n----- Deleting a Film -----");
        film3.delete(viewerFeedbackSystem);
        viewerFeedbackSystem.displayFilmDetails(3);
        revenueSimulation.removeFilmFromScreenings(film3);
        // Final status
        System.out.println("\n----- Final Status -----");
        revenueSimulation.printScreeningSchedule();
        viewerFeedbackSystem.displayPopularityRanking();
